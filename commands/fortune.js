...
module.exports = {
  ...
  run(client, message, args)  {
    ...
    const embed = new Discord.MessageEmbed()
        ...
        .addField("Here is a random fortune",fortunes[Math.floor(Math.random()*fortunes.length)])
        .setFooter("Powered by ₴₵ΛЯ ❘❘ HΩMΞTΩШΠ","https://media.discordapp.net/attachments/732543184571334776/751271973027446844/IMG_20200901_205803.jpg?width=427&height=427");
